...
public class SimulationManager : MonoBehaviour
{
    ...
    public GameObject gameWaypoint;
    ...
    private void InstantiateSimulationPrefab()
    {
        ...
        Transform waypoint = gameWaypoint.transform;

        waypoint.name = "Waypoint";
        Vector3 position = 1.2f * Vector3.up + 1000 * Vector3.forward;
        waypoint.position.Set(position.x, 0.0f, position.z);
        waypoint.localScale = 0.5f * Vector3.one;
